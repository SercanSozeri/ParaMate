  ...
  sections: [
    {
      ...
      fields: [
        ...
        },
        {
          ...
          type: 'textarea',
          required: true,
          example: 'Patient fell at station.',
        },
      ],
    },
    {
      ...
      fields: [
        {
          ...
          type: 'textarea',
          required: true,
          example: 'Patient conscious, stable.',
        },
        {
          key: 'actionTaken',
          label: 'Action Taken',
          type: 'textarea',
          required: true,
          example: 'Assessed and transported.',
        },
        {
